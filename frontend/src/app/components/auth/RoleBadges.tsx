...
const roleIcon: Record<Role, any> = {
  student: GraduationCap, supervisor: BookOpen, admin: ShieldCheck, company: Building2, alumni: Award,
};

type Props = { role: Role; onChange: (r: Role) => void };

export function RoleBadges({ role, onChange }: Props) {
  return (
